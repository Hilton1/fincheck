export function CheckingIcon() {
  return (
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M13 19.8341H31" stroke="#495057" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M17.1768 25.1701H20.1453" stroke="#495057" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
